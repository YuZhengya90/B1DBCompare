...
[Advanced using for user defined query]:
you can choose to compare two queries what ever you want. But you must keep the records
number to be the same.

[Add Business Objects by yourself]:
You can add busines Objects by yourself in querybox.txt.
the format of this file should be like:
<Empty line after exist>
BO:XXX(BO NAME)
MainTable:select * from <MainTable> where <SelectColumn> = (?)
Table1:select ...
...

Then restart Application. The new object could be inserted.
